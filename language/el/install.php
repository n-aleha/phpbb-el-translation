...
$lang = array_merge($lang, array(
	...
	'BACKUP_NOTICE'					=> 'Παρακαλούμε να δημιουργήσετε αντίγραφα ασφαλείας της ιστοσελίδας σας πριν από την ενημέρωση σε περίπτωση που προκύψουν προβλήματα κατά τη διαδικασία ενημέρωσης.',
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Έχετε επιτυχώς μετατρέψει το σύστημά σας σε phpbb 3.1. Μπορείτε τώρα να συνδεθείτε και <a href="../">να έχετε πρόσβαση στο σύστημα</a>. Παρακαλώ βεβαιωθείτε ότι οι ρυθμίσεις έχουν μεταφερθεί σωστά πριν ενεργοποιήσετε το σύστημα διαγράφοντας τον φακελο install. Θυμηθείτε ότι βοήθεια σχετικά με το πώς να χρησιμοποιήσετε το phpBB είναι διαθέσιμη απευθείας μέσω των <a href="https://www.phpbb.com/support/docs/en/3.1/ug/">Τεκμηρίωση</a> και στη <a href="https://www.phpbb.com/community/viewforum.php?f=466">Δ. Συζήτηση υποστήριξης</a>.',
	...
	'CONV_ERROR_INCONSISTENT_GROUPS'	=> 'Ασυνέπεια στον πίνακα των ομάδων εμφανίστηκε στο add_bots() - πρέπει να προσθέσετε όλες τις ειδικές ομάδες αν το κάνετε χειροκίνητα.',
	...
	'CONV_ERROR_MESSAGE_PARSER'			=> 'Σφάλμα αναλυτή μηνύμάτων',
	...
	'DL_CONFIG_EXPLAIN'			=> 'Μπορείτε να κατεβάσετε όλο το config.php στο δικό σας PC. Μετά θα χρειαστεί να ανεβάσετε το αρχείο χειροκίνητα, αντικαθιστώντας οποιοδήποτε config.php στον φάκελο του phpBB 3.1. Παρακαλώ θυμηθείτε να ανεβάσετε το αρχείο σε κωδικοποίηση ASCII (δες τις οδηγίες της εφαρμογής FTP αν δεν είσαι σίγουρος πώς γίνετε αυτό). Όταν ανεβάσετε το config.php κάντε κλικ στο “Εντάξει” για να προχωρήσετε στο επόμενο στάδιο.',
	...
	<ul>
		<li>MySQL 3.23 ή νεότερη (υποστηρίζεται MySQLi)</li>
		<li>PostgreSQL 8.3+</li>
		<li>SQLite 2.8.2+</li>
		<li>SQLite 3.6.15+</li>
		<li>MS SQL Server 2000 ή νεότερη (άμεσα ή μέσω ODBC)</li>
		<li>MS SQL Server 2005 ή νεότερη (εγγενώς)</li>
		<li>Oracle</li>
	</ul>
	...
	'INST_ERR_DB_NO_SQLITE3'	=> 'Η έκδοση της επέκτασης SQLite που είναι εγκατεστημένη είναι πολύ παλιά, πρέπει να αναβαθμιστεί τουλάχιστον σε 3.6.15.',
	...
	'MBSTRING_HTTP_INPUT'					=> 'Μετατροπή χαρακτήρων HTTP εισόδου',
	'MBSTRING_HTTP_INPUT_EXPLAIN'			=> '<var>mbstring.http_input</var> πρέπει να ρυθμιστεί σε <samp>pass</samp>.',
	'MBSTRING_HTTP_OUTPUT'					=> 'Μετατροπή χαρακτήρων HTTP εξόδου',
	...
	'MYSQL_SCHEMA_UPDATE_REQUIRED'	=> 'Το σχήμα της MySQL βάσης δεδομένων σας για το phpBB είναι ενημερωμένο. phpBB ανιχνεύει το σχήμα για  MySQL 3.x/4.x, όμως ο κεντρικός υπολογιστής τρέχει σε MySQL %2$s.<br /><strong>Πριν συνεχίσετε την αναβάθμιση, πρέπει πρώτα να ενημερώσετε το σχήμα.</strong><br /><br />Παρακαλώ επισκεφθείτε την <a href="https://www.phpbb.com/kb/article/doesnt-have-a-default-value-errors/">Βάση  Γνώσεων και το άρθρο σχετικά με την ενημέρωση του σχήματος MySQL </a>. Εάν αντιμετωπίσετε προβλήματα, παρακαλώ χρησιμοποιήστε  <a href="https://www.phpbb.com/community/viewforum.php?f=466"> το φόρουμ υποστήριξης</a>.',
	...
	'OVERVIEW_BODY'				=> 'Καλώς ήρθατε στο phpBB3!<br /><br />phpBB® είναι το πιο ευρύτερα χρησιμοποιούμενο ελεύθερο λογισμικού στον κόσμο για bulletin board. Το phpBB3 είναι η πιο πρόσφατη έκδοση στην πορεία που έχει ξεκινήσει από το 2000. Όπως οι προκάτοχοί του, το phpBB3 είναι πλούσιο σε χαρακτηριστικά γνωρίσματα, φιλικό προς τον χρήστη, και πλήρης υποστήριξη από την ομάδα phpBB. Το phpBB3 έχει βελτιώσει κατά πολύ αυτό που έκανε το phpBB2 δημοφιλές, και έχουν προστεθεί νέα χαρακτηριστικά γνωρίσματα που δεν υπήρχαν στις προηγούμενες εκδόσεις Ελπίζουμε ότι υπερβαίνει τις προσδοκίες σας .<br /><br />Αυτό το σύστημα εγκαταστάσεων θα σας καθοδηγήσει μέσω της εγκατάστασης phpBB3, της ενημέρωσης στην ποιο πρόσφατη έκδοση phpBB3 από τις προηγούμενες  εκδόσεις, καθώς επίσης και την μετατροπή σε phpBB3 από ένα διαφορετικό σύστημα πινάκων συζήτησης (συμπεριλαμβανομένου phpBB2). Για περισσότερες πληροφορίες, σας ενθαρρύνουμε να διαβάσετε <a href="../docs/INSTALL.html">τον οδηγό εγκατάστασης</a>.<br /><br />Για να διαβάσετε την άδεια phpBB3 ή να μάθετε περισσότερα για τη λήψη  υποστήριξης και της θέσης μας πάνω σε  αυτό, παρακαλώ επιλέξτε τις αντίστοιχες επιλογές από τις δευτερεύουσες επιλογές. Για να συνεχίσετε, παρακαλώ επιλέξτε την κατάλληλη ετικέτα ανωτέρω.',

	'PCRE_UTF_SUPPORT'				=> 'Υποστήριξη PCRE UTF-8',
	'PCRE_UTF_SUPPORT_EXPLAIN'		=> 'Το phpBB <strong>δεν</strong> θα λειτουργήσει αν η μονάδα PHP δεν έχει μεταγλωτιστεί με υποστήριξη UTF-8 στην PCRE επέκτασή της.',
	'PHP_GETIMAGESIZE_SUPPORT'			=> 'Η συνάρτηση της PHP, getimagesize() είναι διαθέσιμη',
	'PHP_GETIMAGESIZE_SUPPORT_EXPLAIN'	=> '<strong>Απαραίτητο</strong> - Για να λειτουργεί σωστά το phpBB, η συνάρτηση getimagesize πρέπει να είναι διαθέσιμη.',
	'PHP_JSON_SUPPORT'				=> 'Υποστήριξη PHP JSON ',
	'PHP_JSON_SUPPORT_EXPLAIN'		=> '<strong>Απαραίτητο</strong> - Για να λειτουργεί σωστά το phpBB, η επέκταση της PHP για JSON θα πρέπει να είναι διαθέσιμη.',
	...
	'PHP_SETTINGS_EXPLAIN'			=> '<strong>Απαραίτητο</strong> - Πρέπει να έχετε τουλάχιστον την έκδοση 5.3.3 της PHP για την εγκατάσταση του phpBB. Αν το <var>safe mode</var> εμφανίζετε κάτω από το PHP η εγκατάσταση τρέχει σε ασφαλή λειτουργία. Αυτό όμως επιφέρει περιορισμούς στην απομακρυσμένη διαχείριση και σε παρόμοιες λειτουργίες.',
	...
	'PHP_VERSION_REQD'				=> 'Έκδοση PHP >= 5.3.3',
	...
	'SELECT_FORUM_GA'			=> 'Στο phpBB 3.1 οι γενικές ανακοινώσεις συνδέονται με forums. Διαλέξτε ένα forum για τις τωρινές γενικές ανακοινώσεις (μπορεί να μεταφερθεί αργότερα):',
	...
	'STAGE_CREATE_TABLE_EXPLAIN'	=> 'Οι πίνακες που χρησιμοποιούνται από το phpBB 3.1 έχουν δημιουργηθεί και εμπλουτιστεί με δεδομένα. Προχωρήστε στην επόμενη οθόνη για την ολοκλήρωση της εγκατάστασης του phpBB.',
	...
	'SUPPORT_BODY'				=> 'Η πλήρης υποστήριξη θα παρασχεθεί για την τρέχουσα σταθερή έκδοση phpBB3, δωρεάν. Αυτό περιλαμβάνει:</p><ul><li>εγκατάσταση</li><li>ρυθμίσεις</li><li>τεχνικές ερωτήσεις</li><li>προβλήματα σχετικά με τα πιθανά λάθη στο λογισμικό </li><li>ενημέρωση από Release Candidate (RC) εκδόσεις  στην τελευταία τελική έκδοση</li><li>μετατροπή από phpBB 2.0.x σε phpBB3</li><li>μετατροπή από άλλο λογισμικό πινάκων συζήτησης  σε phpBB3 (παρακαλώ δείτε <a href="https://www.phpbb.com/community/viewforum.php?f=486">Μετατροπή Φόρουμ</a>)</li></ul><p>Ενθαρρύνουμε τους χρήστες που τρέχουν ακόμα τις δοκιμαστικές εκδόσεις phpBB3 να αντικαταστήσουν την εγκατάστασή τους με ένα νέο αντίγραφο της πιο πρόσφατης έκδοση.</p><h2>Επεκτάσεις / Στυλ</h2><p>Για τα ζητήματα σχετικά με τις Επεκτάσεις, παρακαλώ δημοσιεύστε μέσα στο <a href="https://www.phpbb.com/community/viewforum.php?f=451">Extensions Forum</a>.<br />Για τα ζητήματα σχετικά με  θέματα, πρότυπα και σύνολα εικόνων, παρακαλώ δημοσιεύστε μέσα στο <a href="https://www.phpbb.com/community/viewforum.php?f=471">Styles Forum</a>.<br /><br />Εάν η ερώτησή σας αφορά ένα συγκεκριμένο πακέτο, παρακαλώ δημοσιεύστε άμεσα στο θέμα που έχει οριστεί για το πακέτο.</p><h2>Λήψη Υποστήριξης</h2><p><a href="https://www.phpbb.com/community/viewtopic.php?f=14&amp;t=571070">Το πακέτο καλώς ορίσματος  phpBB Welcome Package</a><br /><a href="https://www.phpbb.com/support/">Περιοχή Υποστήριξης</a><br /><a href="https://www.phpbb.com/support/docs/en/3.1/ug/quickstart/">Γρήγορος Οδηγός Έναρξης</a><br /><br />Για να σιγουρευτείτε ότι έχετε τα τελευταία νέα, γιατί όχι <a href="https://www.phpbb.com/support/">εγγραφείτε στη λίστα ηλεκτρονικού ταχυδρομείου</a>;<br /><br />',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Όλα τα αρχεία είναι ενημερωμένα στην τελευταία έκδοση του phpBB.',
	...
	'CURRENT_FILE'					=> 'Αρχή της Σύγκρουσης - Υπάρχει κώδικας του Αρχικού Αρχείου πριν την αναβάθμιση',
	'CURRENT_VERSION'				=> 'Τρέχουσα έκδοση',

	'DATABASE_TYPE'						=> 'Τύπος Β. Δεδομένων',
	'DATABASE_UPDATE_COMPLETE'			=> 'Η αναβάθμιση της Β. Δεδομένων ολοκληρώθηκε!',
	'DATABASE_UPDATE_CONTINUE'			=> 'Συνεχίστε με την αναβάθμιση της Β. Δεδομένων',
	...
	'DATABASE_UPDATE_NOT_COMPLETED'		=> 'Η αναβάθμιση της Β. Δεδομένων δεν έχει ολοκληρώθεί ακόμα.',
	...
	'ERROR'			=> 'Σφάλμα',
	'EVERYTHING_UP_TO_DATE'		=> 'Το σύστημα σας αναβαθμίστηκε στην τελευταία έκδοση του phpBB. Θα πρέπει τώρα να <a href="%1$s">συνδεθείτε</a> και να ελένξετε αν όλα λειτουργούν σωστά. Μην ξεχάσετε να διαγράψετε, μετονομάσετε ή να μετακινήσετε τον φάκελο εγκατάστασης (install)! Παρακαλούμε να μας στείλετε ανανεωμένες πληροφορίες για τον διακομιστή σας και το σύστημα μας από <a href="%2$s">Αποστολή πληροφορίες στατιστικών</a> που είναι στον Πίνακα Ελέγχου Διαχειριστή.',
	...
	'FILES_DELETED_EXPLAIN'			=> 'Τα επόμενα αρχεία δεν υπάρχουν στην νέα έκδοση. Αυτά τα αρχεία πρέπει να διαγραφούν από την εγκατάσταση σας.',
	...
	'NO_UPDATE_FILES_OUTDATED'		=> 'Κανένας φάκελος δεν μπορεί να βρεθεί για την αναβάθμιση, παρακαλώ σιγουρευτείτε ότι έχετε ανεβάσει όλα τα σχετικά αρχεία.<br /><br />Η εγκατάστασή σας <strong>δεν</strong> φαίνεται να είναι αναβαθμισμένη. Οι αναβαθμίσεις που είναι διαθέσιμες για την έκδοση του phpBB %1$s, παρακαλώ επισκευτείτε <a href="https://www.phpbb.com/downloads/" rel="external">https://www.phpbb.com/downloads/</a> για να αποκτήσετε το κατάλληλο πακέτο αναβάθμισης από την έκδοση %2$s στην έκδοση %3$s.',
	...
	'SHOW_DIFF_DELETED'			=> 'Δείτε το περιεχόμενο του αρχείου',
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>Παρακαλώ διαβάστε την ανακοίνωση για την τελευταία έκδοση πριν συνεχίσετε την διαδικασία αναβάθμισης, ίσως να περιέχει χρήσιμες πληροφορίες. Επίσης περιέχει χρήσιμους συνδέσμου μεταφόρτωσης όπως και το ιστορικό αλλαγής.</p>
		...
		<ul style="margin-left: 20px; font-size: 1.1em;">
			<li>Πηγαίνετε στη <a href="https://www.phpbb.com/downloads/" title="https://www.phpbb.com/downloads/">σελίδα μεταφορτώσεων phpBB.com</a> και κατεβάστε το σωστό "Automatic Update Package" συμπιεσμένο αρχείο.<br /><br /></li>
			<li>Αποσυμπιέστε το αρχείο.<br /><br /></li>
			<li>Ανεβάστε όλο τον (αποσυμπιεσμένο) φάκελο εγκατάστασης (install) στον φάκελο του phpBB (εκεί που είναι το config.php).<br /><br /></li>
		</ul>

		<p>Μόλις γίνει αυτό το σύστημα θα είναι εκτός για τους απλούς χρήστες αφού ο φάκελος εγκατάστασης θα υπάρχει.<br /><br />
		<strong><a href="%1$s" title="%1$s">Τώρα ξεκινήστε την διαδικασία αναβάθμισης αφού βάλετε στον πλοηγό σας την τοποθεσία του φακέλου εγκατάστασης</a>.</strong><br />
		<br />
