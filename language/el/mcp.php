...
$lang = array_merge($lang, array(
	...
	'ADD_FEEDBACK_EXPLAIN'	=> 'Εάν θα επιθυμούσατε να προσθέσετε μια αναφορά σχετικά με αυτό, παρακαλούμε συμπληρώστε την ακόλουθη φόρμα. Χρησιμοποιήστε μόνο απλό κείμενο, HTML, BBCode, κ.λπ. δεν επιτρέπεται.',
	'ADD_WARNING'			=> 'Προσθέστε προειδοποίηση',
	'ADD_WARNING_EXPLAIN'	=> 'Για να στείλετε μια προειδοποίηση σε αυτό το μέλος, παρακαλούμε συμπληρώστε την ακόλουθη φόρμα. Χρησιμοποιήστε μόνο απλό κείμενο, HTML, BBCode, κ.λπ. δεν επιτρέπεται',
	...
	'APPROVE_POST_CONFIRM'	=> 'Σίγουρα θέλετε να εγκρίνετε αυτή την δημοσίευση;',
	'APPROVE_POSTS'			=> 'Έγκριση δημοσιεύσεων',
	'APPROVE_POSTS_CONFIRM'	=> 'Σίγουρα θέλετε να εγκρίνετε τις επιλεγμένες δημοσιεύσεις;',
	'APPROVE_TOPIC'			=> 'Έγκριση θέματος',
	'APPROVE_TOPIC_CONFIRM'	=> 'Σίγουρα θέλετε να εγκρίνετε αυτό το θέμα;',
	'APPROVE_TOPICS'		=> 'Έγκριση θεμάτων',
	'APPROVE_TOPICS_CONFIRM'=> 'Σίγουρα θέλετε να εγκρίνετε τα επιλεγμένα θέματα;',

	'CANNOT_MOVE_SAME_FORUM'=> 'Δεν μπορείτε να μετακινήσετε το θέμα στη Δ. Συζήτηση στην οποία αυτό βρίσκεται.',
	...
	'CLOSE_PM_REPORT_CONFIRM'	=> 'Σίγουρα θέλετε να κλείσετε την επιλεγμένη αναφορά ΠΜ;',
	'CLOSE_PM_REPORTS'		=> 'Κλείσιμο αναφορών ΠΜ',
	'CLOSE_PM_REPORTS_CONFIRM'	=> 'Σίγουρα θέλετε να κλείσετε τις επιλεγμένες αναφορές ΠΜ;',
	'CLOSE_REPORT'			=> 'Κλείσιμο αναφοράς',
	'CLOSE_REPORT_CONFIRM'	=> 'Σίγουρα θέλετε να κλείσετε την αναφορά για την επιλεγμένη δημοσίευση;',
	'CLOSE_REPORTS'			=> 'Κλείσιμο αναφορών',
	'CLOSE_REPORTS_CONFIRM'	=> 'Σίγουρα θέλετε να κλείσετε τις αναφορές για τις επιλεγμένες δημοσιεύσεις;',

	'DELETE_PM_REPORT'			=> 'Διαγραφή αναφοράς ΠΜ',
	'DELETE_PM_REPORT_CONFIRM'	=> 'Σίγουρα θέλετε να διαγράψετε την επιλεγμένη αναφορά ΠΜ;',
	'DELETE_PM_REPORTS'			=> 'Διαγραφή αναφοράς ΠΜ',
	'DELETE_PM_REPORTS_CONFIRM'	=> 'Σίγουρα θέλετε να διαγράψετε τις επιλεγμένες αναφορές ΠΜ;',
	'DELETE_POSTS'				=> 'Διαγραφή δημοσιεύσεων',
	'DELETE_REPORT'				=> 'Διαγραφή αναφοράς',
	'DELETE_REPORT_CONFIRM'		=> 'Σίγουρα θέλετε να διαγράψετε την επιλεγμένη αναφορά;',
	'DELETE_REPORTS'			=> 'Διαγραφή αναφορών',
	'DELETE_REPORTS_CONFIRM'	=> 'Σίγουρα θέλετε να διαγράψετε τις επιλεγμένες αναφορές;',
	...
	'DISAPPROVE_POST_CONFIRM'	=> 'Σίγουρα θέλετε να απορρίψετε αυτήν την δημοσίευση;',
	'DISAPPROVE_POSTS'			=> 'Απόρριψη δημοσιεύσεων',
	'DISAPPROVE_POSTS_CONFIRM'	=> 'Σίγουρα θέλετε να απορρίψετε αυτές τις δημοσιεύσεις;',
	...
	'LOCK_POST_POST_CONFIRM'	=> 'Σίγουρα θέλετε να αποτρέψετε την έκδοση αυτής της δημοσίευσης;',
	'LOCK_POST_POSTS'			=> 'Κλειδώστε επιλεγμένες δημοσιεύσεις',
	'LOCK_POST_POSTS_CONFIRM'	=> 'Σίγουρα θέλετε να αποτρέψετε την έκδοση των επιλεγμένων δημοσιεύσεων;',
	'LOCK_TOPIC_CONFIRM'		=> 'Σίγουρα θέλετε να κλειδώσετε αυτό το θέμα;',
	'LOCK_TOPICS'				=> 'Κλειδώστε επιλεγμένα θέματα',
	'LOCK_TOPICS_CONFIRM'		=> 'Σίγουρα θέλετε να κλειδώσετε τα επιλεγμένα θέματα;',
	'LOGS_CURRENT_TOPIC'		=> 'Τρέχον ιστορικό από:',
	'LOGIN_EXPLAIN_MCP'			=> 'Για να συντονίσετε αυτή την Δ. Συζήτηση πρέπει να συνδεθείτε.',
	...
	'MCP_MAKE_ANNOUNCEMENT_CONFIRM'	=> 'Σίγουρα θέλετε να μετατρέψετε αυτό το θέμα σε “Ανακοίνωση”;',
	'MCP_MAKE_ANNOUNCEMENTS'		=> 'Μετατροπή σε “Ανακοινώσεις”',
	'MCP_MAKE_ANNOUNCEMENTS_CONFIRM'=> 'Σίγουρα θέλετε να μετατρέψετε τα επιλεγμένα θέματα σε “Ανακοινώσεις”;',
	'MCP_MAKE_GLOBAL'				=> 'Μετατροπή σε “Γενική ανακοίνωση”',
	'MCP_MAKE_GLOBAL_CONFIRM'		=> 'Σίγουρα θέλετε να μετατρέψετε αυτό το θέμα σε “Γενική ανακοίνωση”;',
	'MCP_MAKE_GLOBALS'				=> 'Μετατροπή σε “Γενικές ανακοινώσεις”',
	'MCP_MAKE_GLOBALS_CONFIRM'		=> 'Σίγουρα θέλετε να μετατρέψετε τα επιλεγμένα θέματα σε “Γενικές ανακοινώσεις”;',
	'MCP_MAKE_STICKY'				=> 'Μετατροπή σε “Σημείωση”',
	'MCP_MAKE_STICKY_CONFIRM'		=> 'Σίγουρα θέλετε να μετατρέψετε αυτό το θέμα σε “Σημείωση”;',
	'MCP_MAKE_STICKIES'				=> 'Μετατροπή σε “Σημειώσεις”',
	'MCP_MAKE_STICKIES_CONFIRM'		=> 'Σίγουρα θέλετε να μετατρέψετε τα επιλεγμένα θέματα σε “Σημειώσεις”;',
	'MCP_MAKE_NORMAL'				=> 'Μετατροπή σε “Τυπικό Θέμα”',
	'MCP_MAKE_NORMAL_CONFIRM'		=> 'Σίγουρα θέλετε να μετατρέψετε αυτό το θέμα σε “Τυπικό Θέμα”;',
	'MCP_MAKE_NORMALS'				=> 'Μετατροπή σε “Τυπικά Θέματα”',
	'MCP_MAKE_NORMALS_CONFIRM'		=> 'Σίγουρα θέλετε να μετατρέψετε τα επιλεγμένα θέματα σε “Τυπικά Θέματα”;',
	...
	'MCP_PM_REPORTS'				=> 'Αναφορές ΠΜ',
	'MCP_PM_REPORT_DETAILS'			=> 'Λεπτομέρειες αναφοράς ΠΜ',
	'MCP_PM_REPORTS_CLOSED'			=> 'Κλειστές αναφορές ΠΜ',
	'MCP_PM_REPORTS_CLOSED_EXPLAIN'	=> 'Αυτή είναι μια λίστα με όλες τις αναφορές για προσωπικά μηνύματα οι οποίες προηγουμένως είχαν λυθεί.',
	'MCP_PM_REPORTS_OPEN'			=> 'Ανοιχτές αναφορές ΠΜ',
	'MCP_PM_REPORTS_OPEN_EXPLAIN'	=> 'Αυτή είναι μια λίστα με όλες τις αναφορές για προσωπικά μηνύματα οι οποίες δεν έχουν λυθεί.',
	...
	'MCP_QUEUE_DELETED_POSTS'				=> 'Δημοσιεύσεις που βρίσκονται προς διαγραφή',
	'MCP_QUEUE_DELETED_POSTS_EXPLAIN'		=> 'Αυτή είναι μια λίστα όλων των δημοσιεύσεων που είναι προσωρινά διαγραμμένες. Εδώ, μπορείτε να τις επαναφέρετε ή να τις διαγράψετε οριστικά.',
	'MCP_QUEUE_DELETED_TOPICS'				=> 'Θέματα που βρίσκονται προς διαγραφή',
	'MCP_QUEUE_DELETED_TOPICS_EXPLAIN'		=> 'Αυτή είναι μια λίστα όλων των θεμάτων που είναι προσωρινά διαγραμμένα. Εδώ, μπορείτε να τα επαναφέρετε ή να τα διαγράψετε οριστικά.',
	...
	'MERGE_POSTS_CONFIRM'	=> 'Σίγουρα θέλετε να συγχωνεύσετε τις επιλεγμένες δημοσιεύσεις;',
	'MERGE_TOPIC_EXPLAIN'	=> 'Με την παρακάτω φόρμα μπορείτε να συγχωνεύσετε δημοσιεύσεις σε ένα άλλο θέμα. Οι δημοσιεύσεις θα παραμείνουν ταξινομημένες και θα εμφανιστούν σαν να τις έκανε το ίδιο μέλος σε αυτό το θέμα.<br />Παρακαλούμε εισάγετε την ταυτότητα θέματος προορισμού ή πατήστε στο «επίλεκτο θέμα» στην αναζήτησή μας.',
	'MERGE_TOPIC_ID'		=> 'Αριθμός αναγνώρισης θέματος προορισμού (ID)',
	'MERGE_TOPICS'			=> 'Συγχώνευση θεμάτων',
	'MERGE_TOPICS_CONFIRM'	=> 'Σίγουρα θέλετε να συγχωνεύσετε τα επιλεγμένα θέματα;',
	...
	'MOVE_TOPIC_CONFIRM'	=> 'Σίγουρα θέλετε να μετακινήσετε αυτό το θέμα, σε μια άλλη Δ. Συζήτηση;',
	'MOVE_TOPICS'			=> 'Μετακίνηση επιλεγμένων θεμάτων',
	'MOVE_TOPICS_CONFIRM'	=> 'Σίγουρα θέλετε να μετακινήσετε τα επιλεγμένα θέματα , σε μια άλλη Δ. Συζήτηση;',
	...
	'NO_DESTINATION_FORUM'			=> 'Παρακαλούμε επιλέξτε μια Δ. Συζήτηση προορισμού.',
	...
	'NO_POSTS_QUEUE'				=> 'Δεν υπάρχουν δημοσιεύσεις που περιμένουν έγκριση.',
	'NO_REASON_DISAPPROVAL'			=> 'Παρακαλούμε εξηγήστε τον λόγο σχετικά με την απόρριψη.',
	...
	'NO_TOPICS_DELETED'				=> 'Δεν υπάρχει κανένα διαγραμμένο θέμα.',
	...
	'QUICKMOD_ACTION_NOT_ALLOWED' => "%s δεν επιτρέπεται μέσω quickmod",

	'PM_REPORT_CLOSED_SUCCESS'	=> 'Η επιλεγμένη αναφορά ΠΜ έχει κλείσει επιτυχώς.',
	'PM_REPORT_DELETED_SUCCESS'	=> 'Η επιλεγμένη αναφορά ΠΜ έχει διαγραφεί επιτυχώς.',
	'PM_REPORTED_SUCCESS'		=> 'Αυτό το προσωπικό μήνυμα έχει επιτυχώς αναφερθεί.',
	'PM_REPORTS_CLOSED_SUCCESS'	=> 'Οι επιλεγμένες αναφορές ΠΜ έχουν κλείσει επιτυχώς.',
	'PM_REPORTS_DELETED_SUCCESS'=> 'Οι επιλεγμένες αναφορές ΠΜ έχουν διαγραφεί επιτυχώς.',
	'PM_REPORTS_TOTAL'			=> array(
		0	=> 'Δεν υπάρχουν αναφορές ΠΜ για αναθεώρηση.',
		1	=> 'Συνολικά υπάρχει <strong>1</strong> αναφορά ΠΜ για αναθεώρηση.',
	...
	'POSTS_RESTORED_SUCCESS'	=> 'Οι επιλεγμένες δημοσιεύσεις επαναφέρθηκαν επιτυχώς.',
	...
	'POST_RESTORED_SUCCESS'		=> 'Αυτή η δημοσίευση επαναφέρθηκε επιτυχώς.',
	...
	'RESTORE_POST_CONFIRM'		=> 'Σίγουρα θέλετε να επαναφέρετε αυτή την δημοσίευση;',
	'RESTORE_POSTS'				=> 'Επαναφορά δημοσιεύσεων',
	'RESTORE_POSTS_CONFIRM'		=> 'Σίγουρα θέλετε να επαναφέρετε τις επιλεγμένες δημοσιεύσεις;',
	'RESTORE_TOPIC'				=> 'Επαναφορά θέματος',
	'RESTORE_TOPIC_CONFIRM'		=> 'Σίγουρα θέλετε να επαναφέρετε αυτό το θέμα;',
	'RESTORE_TOPICS'			=> 'Επαναφορά θεμάτων',
	'RESTORE_TOPICS_CONFIRM'	=> 'Σίγουρα θέλετε να επαναφέρετε τα επιλεγμένα θέματα;',
	'RESYNC'					=> 'Συγχρονισμός ',
	...
	'SELECT_FORUM_GLOBAL_ANNOUNCEMENT'	=> 'Παρακαλούμε επιλέξτε την Δ. Συζήτηση που θέλετε να εμφανίζεται αυτή η γενική ανακοίνωση.',
	'SELECT_FORUM_GLOBAL_ANNOUNCEMENTS'	=> 'Ένα ή περισσότερα θέματα που επιλέξατε είναι γενική ανακοίνωση. Παρακαλούμε επιλέξτε την Δ. Συζήτηση που θέλετε να εμφανίζονται.',
	...
	'SPLIT_TOPIC_ALL_CONFIRM'			=> 'Σίγουρα θέλετε να διασπάσετε αυτό το θέμα;',
	'SPLIT_TOPIC_BEYOND'				=> 'Διάσπαση δημοσίευσης από το επιλεγμένο θέμα',
	'SPLIT_TOPIC_BEYOND_CONFIRM'		=> 'Σίγουρα θέλετε να διασπάσετε την επιλεγμένη δημοσίευση από αυτό το θέμα;',
	...
	'TOPICS_DELETED_SUCCESS'	=> 'Τα επιλεγμένα θέματα έχουν διαγραφεί επιτυχώς από την βάση.',
	'TOPICS_DISAPPROVED_SUCCESS'=> 'Τα επιλεγμένα θέματα έχουν απορριφθεί.',
	'TOPICS_FORKED_SUCCESS'		=> 'Τα επιλεγμένα θέματα έχουν αντιγραφεί επιτυχώς.',
	'TOPICS_LOCKED_SUCCESS'		=> 'Τα επιλεγμένα θέματα κλειδώθηκαν επιτυχώς.',
	'TOPICS_MOVED_SUCCESS'		=> 'Τα επιλεγμένα θέματα μετακινήθηκαν επιτυχώς.',
	'TOPICS_RESTORED_SUCCESS'	=> 'Τα επιλεγμένα θέματα επαναφέρθηκαν επιτυχώς.',
	'TOPICS_RESYNC_SUCCESS'		=> 'Τα επιλεγμένα θέματα συγχρονίστηκαν επιτυχώς.',
	'TOPICS_TYPE_CHANGED'		=> 'Ο τύπος των θεμάτων άλλαξε επιτυχώς.',
	'TOPICS_UNLOCKED_SUCCESS'	=> 'Τα επιλεγμένα θέματα ξεκλειδώθηκαν επιτυχώς.',
	...
	'TOPIC_LOCKED_SUCCESS'		=> 'Το επιλεγμένο θέμα κλειδώθηκε επιτυχώς.',
	'TOPIC_MOVED_SUCCESS'		=> 'Το επιλεγμένο θέμα μετακινήθηκε επιτυχώς.',
	'TOPIC_NOT_EXIST'			=> 'Το θέμα που επιλέξατε δεν υπάρχει.',
	'TOPIC_RESTORED_SUCCESS'	=> 'Το επιλεγμένο θέμα επαναφέρθηκε επιτυχώς.',
	...
	'TOPIC_TYPE_CHANGED'		=> 'Ο τύπος του θέματος άλλαξε επιτυχώς.',
	...
	'UNAPPROVED_POSTS_TOTAL'		=> array(
		0	=> 'Δεν υπάρχει καμία δημοσίευση που περιμένει έγκριση.',
		1	=> 'Συνολικά υπάρχει <strong>1</strong> δημοσίευση που περιμένει έγκριση.',
		2	=> 'Συνολικά υπάρχουν <strong>%d</strong> δημοσιεύσεις που περιμένουν έγκριση.',
	),
	'UNLOCK'						=> 'Ξεκλειδώστε',
	'UNLOCK_POST'					=> 'Ξεκλειδώστε δημοσίευση',
	'UNLOCK_POST_EXPLAIN'			=> 'Επιτρέπεται η επεξεργασία',
	'UNLOCK_POST_POST'				=> 'Ξεκλειδώστε δημοσίευση',
	'UNLOCK_POST_POST_CONFIRM'		=> 'Σίγουρα θέλετε να επιτρέπεται η επεξεργασία της δημοσίευσης;',
	'UNLOCK_POST_POSTS'				=> 'Ξεκλειδώστε τις επιλεγμένες δημοσιεύσεις',
	'UNLOCK_POST_POSTS_CONFIRM'		=> 'Σίγουρα θέλετε να επιτρέπεται η επεξεργασία των επιλεγμένων δημοσιεύσεων;',
	'UNLOCK_TOPIC'					=> 'Ξεκλειδώστε Θέμα',
	'UNLOCK_TOPIC_CONFIRM'			=> 'Σίγουρα θέλετε να ξεκλειδώσετε το θέμα;',
	'UNLOCK_TOPICS'					=> 'Ξεκλειδώστε επιλεγμένα θέματα',
	'UNLOCK_TOPICS_CONFIRM'			=> 'Σίγουρα θέλετε να ξεκλειδώσετε τα επιλεγμένα θέματα;',
	...
	'report_reasons'		=> array(
		...
		'DESCRIPTION' => array(
			...
			'OTHER'		=> 'Το αναφερόμενο μήνυμα δεν ταιριάζει με αυτήν την κατηγορία, παρακαλούμε χρησιμοποιήστε την περαιτέρω φόρμα περιγραφής.',
		),
	),
));
